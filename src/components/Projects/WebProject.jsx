      ...
      <div className='grid mt-[3rem]  lg:px-[2rem] xl:grid-cols-3 gap-[20px] md: auto-cols-max '>
       ...
       {skillIcon.map((item, index) => (
          <div className="text-center">
            ...
            <div className='mt-[1rem]'>     
                <a href='https://youtu.be/R1R3Sk4FOro' target='_blank'  className='mr-[1rem] rounded-[2px] bg-[#1b222b] px-[1rem] py-[0.5rem]'>
                <FontAwesomeIcon  className='mr-[0.3rem]' icon={faExternalLink}/>
                  Live Demo
                </a>
       ...
       {skillIcon.map((item, index) => (
          <div className="text-center">
            <img
              alt=""
              key={index}
              src={item.project6.url}
              className="w-[320px] h-[186px] lg:w-[400px] mt-[1rem] "
            />
            <span key={index}>{item.project6.name}</span>
            <ul className="flex justify-center items-center">
              {item.project6.skill.map((item, index) => (
                <li className="mx-1">
                  <a href="/" className="">
                    <img alt="" key={index} src={item} className="w-[30px]" />
                  </a>
            ...
            <div className='mt-[1rem]'>     
                <a href='https://gamestore-nu.vercel.app/' target='_blank'  className='mr-[1rem] rounded-[2px] bg-[#1b222b] px-[1rem] py-[0.5rem]'>
                <FontAwesomeIcon  className='mr-[0.3rem]' icon={faExternalLink}/>
                  Live Demo
                </a>
